...
var app = new Vue({
  ...
  mounted: function() { //Fired as soon as page is done loading
    ...
    this.loadRobots(); //Get all robots using REST API
  ...
  methods: {
    ...
    reverseList: function() {
      this.robots.reverse(); //Just testing...
    },
    ...
    deleteRobot: function(robot) {
      //Call on the backend REST API to delete the robot. Only called if user has rights.
